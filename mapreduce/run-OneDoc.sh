...
hdfs dfs -D dfs.blocksize=1048576 -put input/new_Doc.txt input
#---------------------------------------------
#Setting hadoop
...
#---------------------------------------------
#Doing Similarity
hdfs dfs -rmr output/one-similarityETL
hdfs dfs -rmr output/one-similarity
hadoop jar Cluster.jar OneDocSimilarityETL output/one-cluster-tfidf/part-r-00000 output/one-similarityETL
#hadoop jar Similarity.jar DXD_test output/one-similarityETL/part-r-00000 output/one-dxd
hdfs dfs -copyToLocal output/one-similarityETL/part-r-00000 output/one-doc-similarity-one
hdfs dfs -copyToLocal output/one-similarityETL/part-r-00001 output/one-doc-similarity-all
#---------------------------------------------
#Doing KmeansETL
