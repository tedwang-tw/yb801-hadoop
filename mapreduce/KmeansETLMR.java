...
public class KmeansETLMR extends Configured implements Tool {
	...
	public int run(String[] args) throws URISyntaxException,IOException,InterruptedException,ClassNotFoundException {
		...
		job.setJarByClass(KmeansETLMR.class);						// set class name 
	...
	public static void main(String[] args) throws Exception {
		int exitCode = ToolRunner.run(new KmeansETLMR(),args);
